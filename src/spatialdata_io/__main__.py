...
@click.option(
    ...
    type=bool,
    default=True,
    help="Value pass internally to _xy2edges. [default: True]",
)
@click.option(
    "--border-scale",
    type=float,
    default=1,
    help="The factor by which the border is scaled. [default: 1]",
)
def dbit_wrapper(
    input: str,
    output: str,
...
@click.option(
    ...
    "-i",
    type=click.Path(exists=True),
    help="Path to the mcmicro project directory.",
    required=True,
)
@click.option(
    "--output",
...
@click.option(
    ...
    type=bool,
    default=True,
    help="Whether to read transcripts.  [default: True]",
)
@click.option(
    "--cells-boundaries",
    type=bool,
    default=True,
    help="Whether to read cells boundaries. [default: True]",
)
@click.option(
    "--cells-table",
    type=bool,
    default=True,
    help="Whether to read cells table.  [default: True]",
)
@click.option(
    "--mosaic-images",
    type=bool,
    default=True,
    help="Whether to read the mosaic images.  [default: True]",
)
...
@click.option(
    ...
    type=bool,
    default=True,
    help="Whether to load images. [default: True]",
)
@click.option(
    "--load-labels",
    type=bool,
    default=True,
    help="Whether to load labels. [default: True]",
)
@click.option(
    "--load-points",
    type=bool,
    default=True,
    help="Whether to load points. [default: True]",
)
@click.option(
    "--load-shapes",
    type=bool,
    default=True,
    help="Whether to load shapes. [default: True]",
)
@click.option(
    "--cells-as-circles",
    type=bool,
    default=False,
    help="Whether to read cells as circles. [default: False]",
)
@click.option(
    "--rois",
...
@click.option(
    ...
    type=bool,
    default=None,
    help="Whether to read cells as circles. [default: None]",
)
@click.option(
    "--cells-labels",
    type=bool,
    default=True,
    help="Whether to read cells labels (raster). [default: True]",
)
@click.option(
    "--nucleus-labels",
    type=bool,
...
@click.option(
    ...
    type=bool,
    default=True,
    help="Whether to read morphology mip image. [default: True]",
)
@click.option(
    "--morphology-focus",
    type=bool,
...
@click.option(
    ...
    type=int,
    default=None,
    help="Subset the image to the first 'c-subset' channels. [default: None]",
)
@click.option(
    "--max-chunk-size",
    type=int,
    default=1024,
    help="Maximum chunk size for x and y dimensions. [default: 1024]",
)
@click.option(
    "--c-chunks-size",
    type=int,
    default=1,
    help="Chunk size for c dimension. [default: 1]",
)
@click.option(
    "--multiscale",
    type=bool,
    default=True,
    help="Whether to create a multiscale image. [default: True]",
)
@click.option(
    "--transformations",
    type=bool,
...
@click.option(
    ...
    type=int,
    default=2,
    help="Default scale factor to use for downsampling. [default: 2]",
)
@click.option(
    "--nuclei-channel-name",
    type=str,
